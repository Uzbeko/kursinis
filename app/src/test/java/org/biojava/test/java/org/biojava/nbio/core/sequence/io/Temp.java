 ...
 *
 */
package org.biojava.test.java.org.biojava.nbio.core.sequence.io;
...
////            InputStream inStream = testRes.openRawResource(R.raw.test);
            InputStream inStream = this.getClass().getClassLoader().getResourceAsStream("test.fasta");
//            InputStream inStream = MyApplication.getAppContext().getResources().openRawResource(R.raw.test);
